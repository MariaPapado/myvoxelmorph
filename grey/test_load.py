...
id = '12_26025_BD_0_4.png'

im1 = imageio.imread('/home/mariapap/CODE/voxelmorph/hir/hir_data/val/T1/{}'.format(id))
im2 = imageio.imread('/home/mariapap/CODE/voxelmorph/hir/hir_data/val/T2/{}'.format(id))
#im1 = np.expand_dims(im1, 0)/255. #RGB
#im2 = np.expand_dims(im2, 0)/255. #RGB

im1 = np.expand_dims(np.expand_dims(im1, 0), 3)/255. #
im2 = np.expand_dims(np.expand_dims(im2, 0), 3)/255. #
